    ...
    <div className="col-lg-12" style={{ position: "relative" }}>
      <div ref={sliderRef} className="keen-slider">
        {collections.map((collection, index) => (
          ...
          >
            <div className="nft_coll" style={{ width: "100%", margin: 0 }}>
              <div
                className="nft_wrap"
                style={{
                  height: "auto",
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: "#fff",
          boxShadow: isLeftHovered ? "0px 6px 14px rgba(0, 0, 0, 0.3)" : "none",
          cursor: "pointer",
          display: "flex",
          alignItems: "center",
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: "#fff",
          boxShadow: isRightHovered ? "0px 6px 14px rgba(0, 0, 0, 0.3)" : "none",
          cursor: "pointer",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
...
const HotCollections = () => {
  ...
  return (
    <section id="section-collections" className="no-bottom" data-aos="fade" data-aos-delay="150" data-aos-duration="1000">
                  ...
                  <div style={{ flex: "1 0 23%" }} key={index}>
                    <div className="nft_coll" style={{ width: "100%", margin: 0 }}>
                      ...
                      <div className="nft_coll_info">
                        ...
                        <span><Skeleton width="50px" height="20px" /></span>
                      </div>
                    </div>
                  </div>
                ))}
